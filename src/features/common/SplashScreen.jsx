...
const SplashScreen = () => {
  return (
    <div
      className={`px-10 flex flex-col justify-center items-center gap-5 bg-[url('${screenShot}')]`}
    >
      <h1 className="text-3xl text-black font-bold text-balance text-center">
      ...
      <Link
        to={"/register"}
        className="bg-orange-500 px-2 py-1 text-m font-semibold rounded-md text-slate-50 text-center"
      >
